<template>
    <div class="container-fluid md: lg xl bg-[#FAFBF8]">
        <header>
            <h1
                class="text-4xl text-center font-bold text-gray-50 bg-[#85ba58] px-3 py-8 m-1"
            >
        ...
        <main class="m-5">
            <p
                class="border-transparent shadow-xl p-2 rounded-lg m-1 text-center m-auto bg-[#e5f4d7]"
            >
