<template>
    ...
    <div class="flex justify-center">
        ...
        >
            <i class="ph ph-info text-2xl"></i>
            <span class="text-left">Select a molecule from the top row and match it with its corresponding image from the bottom row.</span>
            <i class="ph ph-x absolute top-2 right-2 text-xl hover:scale-125 cursor-pointer" @click="hideTutorial"></i>
        </div>
        <div class="flex w-100 h-10">
            <GlassBtn @click="apagar()">
    ...
    <div class="flex justify-center">
        ...
        >
            <i class="ph ph-info text-2xl"></i>
            <span class="text-left">Hautatu molekula bat goiko lerrotik eta lotu beheko lerroko dagokion irudiarekin.</span>
            <i class="ph ph-x absolute top-2 right-2 text-xl hover:scale-125 cursor-pointer" @click="hideTutorial"></i>
        </div>
        <div class="flex w-100 h-10">
            <GlassBtn @click="apagar()">
