    ...
    >
        <div v-show="idioma.find((idioma) => idioma.estado)?.name === 'es'">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                ></i>
                                <p class="max-w-xl mt-3 text-gray-300 text-lg">
                                    Entra en nuestro scape room y descubre un
                                    mundo de aventuras!
                                </p>
                            </div>
            ...
            <ModalStartGame
                ...
                <p>
                    Para ello, deberás superar una serie de pruebas que te
                    llevarán a descubrir la contraseña final y salvar a la
                    humanidad.
                </p>
                <p>
                ...
                <p>
                    Recuerda, tienes solo 30 minutos, y cada vez que falles en
                    un juego, perderás tiempo del reloj en función de la
                    dificultad que hayas elegido. ¡Ánimo, y mucha suerte!
                </p></ModalStartGame
            >
            <ModalStartGame
            ...
            >
                ...
                <p>
                    Para completar el juego tendrás 30 minutos, y por cada fallo
                    en una de las pruebas, según la dificultad, se descontará
                    tiempo del reloj:
                </p>
            ...
            <div v-show="idioma.find((idioma) => idioma.estado)?.name === 'en'">
                    ...
                    >
                        <div class="flex-1">
                            <div class="text-center">
                                ...
                                <p class="my-5">
                                    Enter a nickname to save your progress and
                                    your ranking, and the rankings, and the
                                    access password.
                                </p>
                                <!-- tarjeta -->
                                ...
                                >
                                    <i class="ph ph-info text-2xl"></i>
                                    <span class="text-left">
                                        Here is your first challenge, press the
                                        test tube hidden in the page tube hidden
                                        on the page (you must look well) and
                                        find out how you can find the access
                                        password
                                    </span>
                                    <i
                                        class="ph ph-x absolute top-2 right-2 text-xl hover:scale-125 cursor-pointer"
                ...
                <ModalStartGame
                    ...
                    <p>
                        To do this, you must pass a series of tests that will
                        lead you to discover the final password and save to
                        discover the final password and save humanity.
                    </p>
                    <p>
                        You will have to use your skills and ingenuity to solve
                        the challenges that we challenges we propose you.
                    </p>
                    <p>
                        Remember, you only have 30 minutes, and every time you
                        fail a game, you will lose time from the game, you will
                        lose time off the clock depending on the difficulty you
                        have chosen. Cheer up, and good luck!
                    </p></ModalStartGame
                >
                <ModalStartGame
                    @close="hint.showModalHints = false"
                ...
                >
                    ...
                    <p>
                        To complete the game you will have 30 minutes, and for
                        every failure in one of the one of the tests, depending
                        on the difficulty, time will be deducted from your will
                        be deducted from the clock:
                    </p>
                ...
                <div class="flex flex-col-reverse justify-center md:flex-row">
                            ...
                            <div class="text-center">
                                ...
                                >
                                    ...
                                    <span class="text-left">
                                        ...
                                        orrialdean ezkutatuta dagoen hodia
                                        (begiratu behar duzu ondo) eta aurkitu
                                        nola aurki dezakezun sartzeko pasahitza
                                    </span>
                                    <i
                                        class="ph ph-x absolute top-2 right-2 text-xl hover:scale-125 cursor-pointer"
                                        @click="showModalInfo = false"
                    ...
                    <ModalStartGame
                        ...
                        <p>
                            ...
                            eramango zaituzten proba batzuk gainditu behar
                            dituzu azken pasahitza ezagutzeko eta gizateria
                            salbatzeko.
                        </p>
                        <p>
                            Zure gaitasunak eta asmamena erabili beharko dituzu
                            guk ditugun erronkak konpontzeko proposatzen
                            dizkizugun erronkak.
                        </p>
                        <p>
                            Gogoratu, 30 minutu baino ez dituzula, eta partida
                            bat huts egiten duzun bakoitzean, denbora galduko
                            duzula jokoan, denbora galduko duzu erlojua aukeratu
                            duzun zailtasunaren arabera. Animatu, eta zorte on!
                        </p></ModalStartGame
                    >
                    <ModalStartGame
                        @close="hint.showModalHints = false"
                    ...
                    >
                        ...
                        <p>
                            Jokoa osatzeko 30 minutu izango dituzu, eta
                            hutsegite bakoitzeko probetako bat, zailtasunaren
                            arabera, denbora kenduko zaio zureari erlojutik
                            kenduko da:
                        </p>
