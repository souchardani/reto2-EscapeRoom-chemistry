...
<body>
    <div class="flex flex-col items-center">
        ...
        <div class="flex flex-col md:grid grid-cols-3 gap-6 my-6">
            ...
            <div class="flex text-center justify-center items-center bg-fuchsia-200 w-60 h-48  rounded-xl shadow-lg hover:scale-110 hover:shadow-xl border-2 border-gray-300">
                <a href="{{ route('admin.show.players') }}" class="font-semibold text-xl">Gestión de usuarios</a>
            </div>
        </div>
    </div>
</body>
