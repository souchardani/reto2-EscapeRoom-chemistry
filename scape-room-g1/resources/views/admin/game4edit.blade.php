...
<div class="text-2xl shadow-xl">
    <form action="{{route('admin.game4storeEdit', $game4->id)}}" method="post"  enctype="multipart/form-data">
        ...
        <div class="flex flex-col">
            ...
            <input type="text" name="growth" id="growth" value="{{$game4->growth}}" class="shadow-xl border rounded-xl p-2"><br>
            ...
            <input type="text" name="caracteristics" id="caracteristics" value="{{$game4->caracteristics}}" class="shadow-xl border rounded-xl p-2"><br>
